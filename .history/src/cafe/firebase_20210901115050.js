...
import { getFirestore, doc, initializeFirestore, CACHE_SIZE_UNLIMITED } from 'firebase/firestore'
...
export default const firestore = initializeFirestore(firebaseApp, {
